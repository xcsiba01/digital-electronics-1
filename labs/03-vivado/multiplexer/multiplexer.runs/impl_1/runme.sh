...
HD_PWD='C:/Users/User/Desktop/Vivado/multiplexer/multiplexer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexer_3bit_4to1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplexer_3bit_4to1.tcl -notrace

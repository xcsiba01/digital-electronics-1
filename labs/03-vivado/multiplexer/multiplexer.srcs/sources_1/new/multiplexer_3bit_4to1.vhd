------------------------------------------------------------
--
-- Example of multiplexer_3bit_4to1 using the when/else
-- assignments.
-- EDA Playground
--
...
------------------------------------------------------------
-- Entity declaration for multiplexer_3bit_4to1
------------------------------------------------------------
entity multiplexer_3bit_4to1 is
    port(
...
end entity multiplexer_3bit_4to1;

------------------------------------------------------------
-- Architecture body for multiplexer_3bit_4to1
------------------------------------------------------------

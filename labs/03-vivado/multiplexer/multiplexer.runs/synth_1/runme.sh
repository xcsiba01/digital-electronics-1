...
HD_PWD='C:/Users/User/Desktop/Vivado/multiplexer/multiplexer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexer_3bit_4to1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplexer_3bit_4to1.tcl
